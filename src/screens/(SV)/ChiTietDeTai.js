  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>
        NGHIÊN CỨU CÁC VẤN ĐỀ BẢO MẬT VÀ THỬ NGHIỆM CÁC TÍNH NĂNG BẢO MẬT KHI
        PHÁT TRIỂN MOBILE APP DỰA TRÊN NỀN TẢNG NATIVE REACT VÀ KOTLIN.
      </Text>
      ...
      <View style={styles.detailContainer}>
        ...
        <Text style={styles.detailText}>
          <Text style={styles.boldText}>Thời gian thực hiện:</Text> 15/12/2024 -
          3/5/2025
        </Text>
        <Text style={styles.detailText}>
