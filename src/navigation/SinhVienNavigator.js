...
function HomeStack() {
  return (
    ...
    >
      <Stack.Screen name="TrangChuSV" component={TrangChuSV} />
      <Stack.Screen
        name="ThongBao"
        component={ThongBao}
        options={{
...
// 📑 Stack Navigator cho tab Danh sách đề tài
...
function CustomDrawerContent(props) {
  ...
  const navigateToTab = (routeName) => {
    navigation.navigate("SinhVienHome", { screen: routeName });
  };
...
export default SinhVienNavigator;
